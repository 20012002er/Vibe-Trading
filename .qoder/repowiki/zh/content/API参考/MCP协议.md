...
- [test_mcp_client_adapter.py](file://agent/tests/test_mcp_client_adapter.py)
- [test_mcp_json_string_args.py](file://agent/tests/test_mcp_json_string_args.py)
...
Transport --> Server["本地 MCP 服务<br/>FastMCP"]
